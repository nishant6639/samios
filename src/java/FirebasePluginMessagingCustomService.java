...
public class FirebasePluginMessagingService extends FirebaseMessagingService {
    ...
    private static final String TAG = "SamantaFirebasePlugin";
    ...
    public void onMessageReceived(RemoteMessage remoteMessage) {
        try{
            ...
            // new ComponentName(this.getApplicationContext(), com.samantapp.app.MyConnectionService.class),
            // "Samanta");

            // PhoneAccount phoneAccount = PhoneAccount.builder(phoneAccountHandle, "Samanta").setCapabilities(PhoneAccount.CAPABILITY_CALL_PROVIDER).build();
            // tm.registerPhoneAccount(phoneAccount);
            // Bundle extras = new Bundle();
            // Uri uri = Uri.fromParts(PhoneAccount.SCHEME_TEL, "93493939", null);
            ...
            Intent dialogIntent = new Intent(this, com.samantapp.app.MainActivity.class);
