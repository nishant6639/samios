...
public class BackgroundModeExt extends CordovaPlugin {
                            ...
                            CallbackContext callback)
    {
        ...
        switch (action)
        {
            ...
            case "requestTopPermissions":
                ...
                break;
            case "getTopPermissionsStatus":
                getTopPermissionsStatus(callback);
                break;
            case "tasklist":
                excludeFromTaskList();
                break;
    ...
    private void getTopPermissionsStatus(CallbackContext callback){
        if (SDK_INT >= M) {
            ...
            // }
            // else{
                PluginResult res   = new PluginResult(Status.OK, Settings.canDrawOverlays(activity.getApplicationContext()));
                callback.sendPluginResult(res);
            // }
        }
        else{
