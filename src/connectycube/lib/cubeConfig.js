...
config.set = function (options) {
    if (config.chat.reconnectionTimeInterval) {
        console.warn('"config.chat.reconnectionTimeInterval<Number>" will be deprecated in next releases. Use "config.reconnect.chat.timeInterval<Number>" and "config.reconnect.chat.enable<Boolean>" instead.');
    }
